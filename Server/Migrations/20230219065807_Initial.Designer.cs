...
namespace fairSlots.Server.Migrations
{
    ...
    [Migration("20230219065807_Initial")]
            ...
            modelBuilder.Entity("fairSlots.Shared.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GameID = 1,
                            BetAmount = 20.00m,
                            Date = new DateTime(2023, 2, 18, 22, 58, 7, 80, DateTimeKind.Local).AddTicks(2987),
                            Funds = 200.00m,
                            PlayerID = 1,
                            Win = true
                        },
                        new
                        {
                            GameID = 2,
                            BetAmount = 50.00m,
                            Date = new DateTime(2023, 2, 18, 22, 58, 7, 80, DateTimeKind.Local).AddTicks(3052),
                            Funds = 5000.00m,
                            PlayerID = 2,
                            Win = false
                        });
